...
public class VOS360_CNSCapacity_BulkInvoice {
    ...
    @Test
    public void bulkInvoice_Generation_CNSCapacity() {
        ...
        try {
            ...
            invSheetName = "Bulk_Invoice_SW_Capacity";
            srcFile = new File(filepath);
            fis = new FileInputStream(srcFile);
            wb = new XSSFWorkbook(fis);
            sheet = wb.getSheet(invSheetName);
            scenarioName = "Bulk_Invoice_SW_Capacity";
            int bulkColumns = 25;
