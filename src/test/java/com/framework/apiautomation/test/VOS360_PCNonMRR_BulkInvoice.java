...
public class VOS360_PCNonMRR_BulkInvoice {
    ...
    @Test
    public void bulkInvoice_Generation_PCNonMRR() {
        ...
        try {
            ...
            invSheetName = "Bulk_Invoice_VOS360PC_NonMRR";
            srcFile = new File(filepath);
            fis = new FileInputStream(srcFile);
            wb = new XSSFWorkbook(fis);
            sheet = wb.getSheet(invSheetName);
            scenarioName = "Bulk_Invoice_VOS360PC_NonMRR";
            int bulkColumns = 28;
