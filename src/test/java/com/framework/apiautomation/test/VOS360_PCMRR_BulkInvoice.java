...
public class VOS360_PCMRR_BulkInvoice {
    ...
    @Test
    public void bulkInvoice_Generation_PCMRR() {
        ...
        try {
            ...
            invSheetName = "Bulk_Invoice_VOS360PC_MRR";
            srcFile = new File(filepath);
            fis = new FileInputStream(srcFile);
            wb = new XSSFWorkbook(fis);
            sheet = wb.getSheet(invSheetName);
            scenarioName = "Bulk_Invoice_VOS360PC_MRR";
            int bulkColumns = 28;
