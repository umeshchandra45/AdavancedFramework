...
public class VOS360_NonMRR_BulkInvoice {
    ...
    @Test
    public void bulkInvoice_Generation_VOS360NonMRR() {
        ...
        try {
            ...
            invSheetName = "Bulk_Invoicing_VOS360_NonMRR";
            srcFile = new File(filepath);
            fis = new FileInputStream(srcFile);
            wb = new XSSFWorkbook(fis);
            sheet = wb.getSheet(invSheetName);
            scenarioName = "Bulk_Invoicing_VOS360_NonMRR";
            int bulkColumns = 28;
