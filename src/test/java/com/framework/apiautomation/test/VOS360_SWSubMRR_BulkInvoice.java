...
public class VOS360_SWSubMRR_BulkInvoice {
    ...
    @Test
    public void bulkInvoice_Generation_SWSubMRR() {
        ...
        try {
            ...
            invSheetName = "Bulk_Invoice_SW-Sub_MRR";
            srcFile = new File(filepath);
            fis = new FileInputStream(srcFile);
            wb = new XSSFWorkbook(fis);
            sheet = wb.getSheet(invSheetName);
            scenarioName = "Bulk_Invoice_SW-Sub_MRR";
            int bulkColumns = 28;
