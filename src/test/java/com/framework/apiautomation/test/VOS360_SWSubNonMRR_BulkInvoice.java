...
public class VOS360_SWSubNonMRR_BulkInvoice {
    ...
    @Test
    public void bulkInvoice_Generation_SWSubNonMRR() {
        ...
        try {
            ...
            invSheetName = "Bulk_Invoice_SW-Sub_NonMRR";
            srcFile = new File(filepath);
            fis = new FileInputStream(srcFile);
            wb = new XSSFWorkbook(fis);
            sheet = wb.getSheet(invSheetName);
            scenarioName = "Bulk_Invoice_SW-Sub_NonMRR";
            int bulkColumns = 28;
