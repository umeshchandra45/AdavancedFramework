...
public class VOS360_ServiceMRR_BulkInvoice {
    ...
    @Test
    public void bulkInvoice_Generation_ServiceMRR() {
        ...
        try {
            ...
            invSheetName = "Bulk_Invoice_ServiceMRR";
            srcFile = new File(filepath);
            fis = new FileInputStream(srcFile);
            wb = new XSSFWorkbook(fis);
            sheet = wb.getSheet(invSheetName);
            scenarioName = "Bulk_Invoice_ServiceMRR";
            int bulkColumns = 25;
