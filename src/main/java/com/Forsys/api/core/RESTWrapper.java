...
public class RESTWrapper {
    ...
    /**
     * Wrapper for all restAssured calls with Header mapper, Content Type, End point, Request body
     * as String and Type of method request This is the common method for all the Restassured
     * requests.
     *
     ...
     */
    public static Responses doRequest(HashMap<String, Header> header,
        ...
        if (queryParams != null) {
            ...
            for (String s : queryParams.keySet()) {
                params.add(s, queryParams.get(s));
            }
            wr.queryParams(params);
        }
