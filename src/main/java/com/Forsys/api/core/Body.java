...
import com.Forsys.exceptions.NotSupportedMethodException;
...
public class Body {
    ...
    /**
     * get the body string of body override this method when writing new Body type and body payload
     * is string
     *
    ...
    /**
     * get body as byte array override this method when writing new Body type and body payload is
     * not string
     *
     * @return byte array
     */
    ...
    public <T> T getObject(String jPath, Class<T> clazz) throws NoSuchFieldException {
        throw new NotSupportedMethodException(
                                              "getObject(jpath, class) method is not supported in " + this.getClass()
                                                                                                          .getSimpleName());
    }

    public <T> T getObject(Class<T> clazz) throws NoSuchFieldException {
        throw new NotSupportedMethodException(
                                              "getObject(class) method is not supported in " + this.getClass()
                                                                                                   .getSimpleName());
    }
