...
public class Executor {
    ...
    public static Responses doGetCall(String strEndPoint, String body, Map<String, String> headers) throws Exception {
        Request req = new Request(Method.GET, new EndPoint(strEndPoint));
        setHeaders(req, headers);
        setBody(req, body);
        return req.doExecute();
    ...
    public static Responses doGetCall(String strEndPoint, Map<String, String> headers, Map<String, String> queryParams)
        throws Exception {
        Request req = new Request(Method.GET, new EndPoint(strEndPoint));
        setHeaders(req, headers);
        setBody(req, "");
        return req.doExecuteWithQueryParams(queryParams);
    }
    ...
    public static Responses doPostCall(String strEndPoint, Map<String, String> headers) throws Exception {
        Request req = new Request(Method.POST, new EndPoint(strEndPoint));
        setHeaders(req, headers);
        setBody(req, null);
        return req.doExecute();
    ...
    public static <T> T doPostCallWithPojo(String strEndPoint,
                                           String strBody,
    ...
    public static <T> T doPutCallWithPojo(String strEndPoint,
                                          String strBody,
                                          Map<String, String> headers,
                                          Class<T> responsePojo) throws Exception {
    ...
    public static <T> T doDeleteCallWithPojo(String strEndPoint,
                                             String strBody,
                                             Map<String, String> headers,
                                             Class<T> responsePojo) throws Exception {
