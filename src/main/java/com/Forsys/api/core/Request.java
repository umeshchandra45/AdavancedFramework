...
public class Request {
    ...
    public Responses doExecute() throws Exception {
        Responses res = RESTWrapper.doRequest(this.getHeaders(),
                                              null,
                                              "application/json",
    ...
    /**
     * Execute the request with Query parameters
     * 
     * @param queryParams
     * @return
     * @throws Exception
    ...
    public Responses doExecuteWithQueryParams(Map<String, String> queryParams) throws Exception {
        Responses res = RESTWrapper.doRequest(this.getHeaders(),
                                              queryParams,
                                              "application/json",
                                              this.getEndpoint().getUrl(),
